				...
				<Container fluid>
					<Navbar.Brand href="#" className="py-0">
						...
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 443 148" className="logo">
							...
							<path className="cls-1" d="M131.81,87.94c-9.22-27.41-18.44-55.16-27.64-83.44h23.15q8.14,28.35,16.3,56.24H144q8.25-28.32,16.48-56.23h21.28c-9.29,27.3-18.61,54.77-27.93,82.61q0,20.47-.06,40.94-11,.53-22,1.25Z"></path><path class="cls-1" d="M212,58.89h28V76.45q-14-.11-28-.06v50q-11,.07-22.07.32,0-61.13.09-122.27h58V22q-18-.05-36,0Q212,40.47,212,58.89Z"></path>
